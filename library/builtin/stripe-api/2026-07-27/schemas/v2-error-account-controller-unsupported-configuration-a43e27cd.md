---
title: v2.error.account_controller_unsupported_configuration
page_id: schema-v2-error-account-controller-unsupported-configuration-a43e27cd
path: schemas
description: Connect integration combination is not supported when UA beta is disabled.
