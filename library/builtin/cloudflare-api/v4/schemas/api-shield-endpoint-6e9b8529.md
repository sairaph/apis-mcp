...
page_id: schema-api-shield-endpoint-6e9b8529
path: schemas
...
```yaml
{"description": "The endpoint which can contain path parameter templates in curly braces, each will be replaced from left to right with {varN}, starting with {var1}, during insertion. This will further be Cloudflare-normalized upon insertion. See: https://developers.cloudflare.com/rules/normalization/how-it-works/.", "type": "string", "format": "uri-template", "example": "/api/v1/users/{var1}", "maxLength": 4096, "pattern": "^/.*$", "x-auditable": true}
```
