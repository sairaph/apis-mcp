---
title: Get app
page_id: operation-get-accounts-account-id-flagship-apps-app-id-a9060d83
path: operations/apps
description: Returns an app's name and audit fields. Flag definitions are not included.
