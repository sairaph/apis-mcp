...
page_id: operation-patch-accounts-account-id-registrar-sandbox-registrations-domain-name-974f15ec
...
operation_ids:
    - sandbox-registrar-domain-registration-update
source_type: openapi
...
Operation ID: `sandbox-registrar-domain-registration-update`
