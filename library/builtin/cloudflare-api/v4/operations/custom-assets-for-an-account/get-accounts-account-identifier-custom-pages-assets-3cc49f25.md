...
page_id: operation-get-accounts-account-identifier-custom-pages-assets-23ca50a4
path: operations/custom-assets-for-an-account
description: Fetches all the custom assets at the account level.
...
operation_ids:
    - custom-assets-for-an-account-list-custom-assets
source_type: openapi
...
Operation ID: `custom-assets-for-an-account-list-custom-assets`
