...
page_id: operation-post-accounts-account-identifier-custom-pages-assets-0c984c4a
path: operations/custom-assets-for-an-account
description: Creates a new custom asset at the account level.
...
operation_ids:
    - custom-assets-for-an-account-create-a-custom-asset
source_type: openapi
...
Operation ID: `custom-assets-for-an-account-create-a-custom-asset`
