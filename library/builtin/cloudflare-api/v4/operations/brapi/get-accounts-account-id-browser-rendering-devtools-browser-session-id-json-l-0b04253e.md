---
title: List targets.
page_id: operation-get-accounts-account-id-browser-rendering-devtools-browser-session-id-js-b33928bf
...
Operation ID: `brapi-get_DevtoolsJsonList`
