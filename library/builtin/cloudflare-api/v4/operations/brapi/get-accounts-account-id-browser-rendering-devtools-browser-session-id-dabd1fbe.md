...
page_id: operation-get-accounts-account-id-browser-rendering-devtools-browser-session-id-05e0665f
path: operations/brapi
description: Establishes a WebSocket connection to an existing browser session.
...
Operation ID: `brapi-get_DevtoolsBrowser`
