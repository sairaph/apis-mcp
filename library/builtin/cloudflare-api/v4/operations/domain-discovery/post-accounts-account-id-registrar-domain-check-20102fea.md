...
page_id: operation-post-accounts-account-id-registrar-domain-check-6c532415
...
operation_ids:
    - registrar-domain-discovery-check
source_type: openapi
...
Operation ID: `registrar-domain-discovery-check`
