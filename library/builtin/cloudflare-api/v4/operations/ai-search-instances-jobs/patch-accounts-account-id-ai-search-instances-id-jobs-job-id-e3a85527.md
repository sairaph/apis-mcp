...
page_id: operation-patch-accounts-account-id-ai-search-instances-id-jobs-job-id-45151619
...
operation_ids:
    - ai-search-instance-change-job-status
source_type: openapi
...
Operation ID: `ai-search-instance-change-job-status`
