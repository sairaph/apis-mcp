...
page_id: operation-patch-accounts-account-id-ai-search-namespaces-name-instances-id-jobs-jo-37a8b60f
path: operations/ai-search-instances-jobs
description: Cancel an in-progress indexing job for an AI Search instance.
...
operation_ids:
    - ai-search-namespace-instance-change-job-status
source_type: openapi
...
Operation ID: `ai-search-namespace-instance-change-job-status`
