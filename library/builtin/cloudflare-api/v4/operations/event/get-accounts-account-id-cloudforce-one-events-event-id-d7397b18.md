...
page_id: operation-get-accounts-account-id-cloudforce-one-events-event-id-feb99b7d
path: operations/event
description: This Method is deprecated. Please use /events/dataset/:dataset_id/events/:event_id instead.
