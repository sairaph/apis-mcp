...
page_id: operation-patch-accounts-account-id-cloudforce-one-events-event-id-77a4147f
path: operations/event
description: Update an existing event by its identifier.
