...
page_id: operation-get-accounts-account-id-ai-gateway-gateways-gateway-id-logs-id-response-ae0279ad
path: operations/ai-gateway-logs
description: Retrieves the response payload for an AI Gateway log entry.
...
operation_ids:
    - aig-config-get-gateway-log-response
source_type: openapi
