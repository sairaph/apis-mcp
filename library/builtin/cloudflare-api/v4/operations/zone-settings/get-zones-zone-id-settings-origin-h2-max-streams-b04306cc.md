---
title: Get Origin H2 Max Streams Setting
page_id: operation-get-zones-zone-id-settings-origin-h2-max-streams-5aab63de
...
operation_ids:
    - zone-cache-settings-get-origin-h2-max-streams-setting
source_type: openapi
