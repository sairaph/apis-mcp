---
title: Gets the stripe config for a publisher
page_id: operation-get-accounts-account-id-pay-per-crawl-publisher-stripe-fabc7532
...
operation_ids:
    - pay-per-crawl.publisherGetStripeConfig
source_type: openapi
