...
page_id: operation-patch-accounts-account-id-vuln-scanner-credential-sets-credential-set-id-0d90ea95
path: operations/credential-sets
description: Updates a credential set with only the provided fields; omitted fields remain unchanged.
...
Operation ID: `edit-credential-set`
