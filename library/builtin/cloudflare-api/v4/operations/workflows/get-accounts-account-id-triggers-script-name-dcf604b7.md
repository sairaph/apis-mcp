---
title: Get script triggers
page_id: operation-get-accounts-account-id-triggers-script-name-dbd41197
path: operations/workflows
description: Returns the event trigger declarations owned by a Worker script.
...
Operation ID: `wor-get-script-triggers`
