---
title: Replace script triggers
page_id: operation-put-accounts-account-id-triggers-script-name-7c068e6a
path: operations/workflows
description: Replaces all event trigger declarations owned by a Worker script.
...
Operation ID: `wor-replace-script-triggers`
