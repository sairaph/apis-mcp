---
title: Delete Metrics Export
page_id: operation-delete-accounts-account-id-workers-observability-metricsexport-ac04ca55
path: operations/metrics-export
description: Delete one resource configured for Workers Observability metrics export.
...
Operation ID: `metricsExport.delete`
