...
page_id: operation-put-zones-zone-id-access-apps-app-id-settings-05bf5eda
...
operation_ids:
    - zone-level-access-applications-put-update-access-application-settings
source_type: openapi
