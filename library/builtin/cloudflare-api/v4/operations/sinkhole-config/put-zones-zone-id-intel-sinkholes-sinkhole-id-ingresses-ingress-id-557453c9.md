...
page_id: operation-put-zones-zone-id-intel-sinkholes-sinkhole-id-ingresses-ingress-id-f2907615
path: operations/sinkhole-config
description: Update the specified ingress rule. The sinkhole must belong to the same account as the zone.
...
operation_ids:
    - sinkhole-config-update-ingress
source_type: openapi
...
Operation ID: `sinkhole-config-update-ingress`
