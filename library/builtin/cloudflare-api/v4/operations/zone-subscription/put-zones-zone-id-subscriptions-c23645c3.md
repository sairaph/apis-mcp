...
page_id: operation-put-zones-zone-id-subscriptions-60a65e09
path: operations/zone-subscription
description: Updates zone subscriptions, either plan or add-ons. Retained for audit-log coverage. Use the singular `/zones/{zone_id}/subscription` path instead.
...
operation_ids:
    - zone-subscription-update-zone-subscriptions
source_type: openapi
...
Operation ID: `zone-subscription-update-zone-subscriptions`
