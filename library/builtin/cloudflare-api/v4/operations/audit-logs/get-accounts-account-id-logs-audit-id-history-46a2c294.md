...
page_id: operation-get-accounts-account-id-logs-audit-id-history-2907567d
...
http_methods:
    - GET
api_endpoints:
    - /accounts/{account_id}/logs/audit/{id}/history
operation_ids:
    - audit-logs-v2-get-account-audit-log-history
source_type: openapi
...
Operation ID: `audit-logs-v2-get-account-audit-log-history`
