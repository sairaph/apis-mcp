...
page_id: operation-put-zones-zone-id-api-gateway-settings-schema-validation-cabeea37
...
operation_ids:
    - api-shield-schema-validation-update-zone-level-settings
source_type: openapi
